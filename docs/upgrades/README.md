...
- `UPG-2026-03-06-34`: avviata valutazione architetturale MyPortal v2 (worklist-first) per scalabilita 50+ clienti: task engine unico, API paginata/filter server-side, reminder deterministici e strategia migrazione legacy a basso attrito.
