...
- `UPG-2026-03-06-34`: avviata architettura MyPortal v2 (worklist-first) e rilasciati microstep M0a/M0b/M0c: endpoint read-only paginato `clinical-readiness/worklist`, MyPortal con paginazione reale (no full-list in memoria) e decoupling schema readiness in modulo dedicato `api/schemas/clinical.py`.
