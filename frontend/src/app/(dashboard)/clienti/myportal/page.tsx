...
/**
 * MyPortal — Worklist clinica con Card Grid unificata.
 *
 * Single API call, hero con HealthScoreRing, card grid responsiva,
 * filtri avanzati inline, pagination fissa a 24.
 */
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Tracking board clinico-operativo clienti
            </p>
          </div>
        </div>
