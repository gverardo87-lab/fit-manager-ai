...
/**
 * MyPortal Client Detail — Portale Clinico 360° del Chinesiologo.
 *
...
export default function MyPortalClientDetailPage({
  params,
}: {
  ...
  // ═══════════════════════════════════════════════════════════
  // DATA LOADING — 9 hook, tutte con enabled guard
  // ═══════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════
  // COMPUTED VALUES — useMemo per evitare ricalcolo
  // ═══════════════════════════════════════════════════════════
  ...
  // Correlazioni inter-metriche
  const correlations = useMemo(
    () => analyzeCorrelations(measurements, sesso),
    [measurements, sesso],
  );

  // Readiness item per questo cliente
  ...
  const compliancePct = useMemo(() => {
    ...
    // Settimane passate o correnti solo
    const now = new Date();
